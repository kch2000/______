const CACHE='eliptica-pwa-v30';
const ASSETS=['./','index.html','eliptica_pwa_reescrita_desde_cero_v30_ticker_fix.html','app.js','manifest.webmanifest','icon-192.png','icon-512.png'];
