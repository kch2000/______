const CACHE='eliptica-v72-cache';
const CORE=['./','./index.html?v=v72','./app.js?v=v72','./manifest.webmanifest?v=v72','./icon-192.png?v=v72','./icon-512.png?v=v72'];
  ...
  if(isNav){
    e.respondWith((async()=>{
      try{
        ...
        cache.put('./index.html?v=v72', fresh.clone());
        return fresh;
      }catch(err){
        return (await caches.match('./index.html?v=v72')) || (await caches.match('./index.html')) || Response.error();
      }
    })());
    return;
  }
